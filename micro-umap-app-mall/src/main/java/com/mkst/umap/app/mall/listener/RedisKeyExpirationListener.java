package com.mkst.umap.app.mall.listener;
...
import com.mkst.umap.app.mall.config.RedisConfigProperties;
	...
	public void onMessage(Message message, byte[] bytes) {
		...
		if(StrUtil.format("__keyevent@{}__:expired", redisConfigProperties.getDatabase()).equals(channel)){
			...
			if(body.contains(MallConstants.REDIS_ORDER_KEY_IS_PAY_0)) {
				...
				if(orderInfo != null && MallConstants.NO.equals(orderInfo.getIsPay())){//只有待支付的订单能取消
