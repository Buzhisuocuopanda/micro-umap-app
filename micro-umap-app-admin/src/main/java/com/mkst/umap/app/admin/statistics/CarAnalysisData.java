 ...
 */
@Component("carAnalysisData")
public class CarAnalysisData implements AnalysisDataBase {
    @Autowired
    public CarApplyMapper carApplyMapper;
    ...
    public AppAnalysisResult getData(Map<String, Object> params) {
        ...
        data.setToday(carApplyMapper.selectTotalByDay(MyDateUtil.format(DateUtil.date()) + " 00:00:00"
                ,MyDateUtil.format(DateUtil.date()) + " 23:59:59"));
        data.setTotal(carApplyMapper.selectTotal());
        data.setList(carApplyMapper.selectCarOrderList(startDate,endDate));
        return data;
    }
}
